...
#ifndef EPH_FONT_AWESOME_BRANDS_H
#    define EPH_FONT_AWESOME_BRANDS_H

#    include <Core/Ephemeral.h>

#    define FONT_ICON_FILE_NAME_FAB ( Ephemeral::FileSystem::GetCoreAssetPath() / "Fonts/FontAwesome/fa-brands-400.ttf" ).string()
